...
from allennlp.data.tokenizers import Token, PretrainedTransformerTokenizer, ElectraTokenizer
from allennlp.data.token_indexers.token_indexer import TokenIndexer, IndexedTokenList

logger = logging.getLogger(__name__)

from help_tira_run import PretrainedTransformerTokenizer1


@TokenIndexer.register("pretrained_transformer")
class PretrainedTransformerIndexer1(TokenIndexer):
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._allennlp_tokenizer = PretrainedTransformerTokenizer1('google/electra-base-discriminator')
...
class PretrainedTransformerMismatchedIndexer1(TokenIndexer):
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._matched_indexer = PretrainedTransformerIndexer1(
            model_name,
            namespace=namespace,
