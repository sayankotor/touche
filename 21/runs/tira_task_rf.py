...
def run_baseline(output_dir = '/notebook/touche/output/', input_dir = '/notebook/touche/', input_file = 'topics-task-2-only-titles.xml'):
    ...
    #write_qrels(output_dir, "random_forest_v1", answs)
    test_ds = pd.read_pickle("/notebook/touche2021/test_ds.pkl")
    answs_test = transform(rf_pipe, test_ds)
    write_qrels(output_dir, "random_forest_v1_test", answs_test)
